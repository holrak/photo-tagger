...
sidecar_mode = "all"      # "none" embeds into the image file; "raw" is a sidecar for RAW only.
...
# session_gap_minutes = 60       # Group photos into shoots and harmonize each shoot.
